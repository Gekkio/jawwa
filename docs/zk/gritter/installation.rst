...
.. parsed-literal::
  ...
  <dependency org="fi.jawsy.jawwa" name="jawwa-zk-gritter" rev="|release|" />
...
.. parsed-literal::
  ...
  val jawwaZkGritter = "fi.jawsy.jawwa" % "jawwa-zk-gritter" % "|release|"
...
.. parsed-literal::
  ...
  libraryDependencies += "fi.jawsy.jawwa" % "jawwa-zk-gritter" % "|release|"
